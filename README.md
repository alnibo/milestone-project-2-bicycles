...
The inspiration for the general layout came from this [project](https://github.com/Angie55/IFD_Milestone_Project_Two_Dashboard). From that project I also took the code for the donut and composite charts as starting bases and then changed it to fit my needs.
